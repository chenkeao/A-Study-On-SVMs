...
\newcommand{\secondlogoblock}{$if(second-logo)$
{$if(titlepage-theme.logo-align)$\titlepagelogoalign
$endif$\includegraphics[width=$if(titlepage-theme.logo-size)$$titlepage-theme.logo-size$$else$0.2\textwidth$endif$]{$second-logo$}}
  \vspace{$if(titlepage-theme.logo-space-after)$$titlepage-theme.logo-space-after$$else$0pt$endif$}
$endif$}
